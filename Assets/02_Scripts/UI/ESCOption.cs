...
public class ESCOption : MonoBehaviour
{
    ...
    [SerializeField] private RectTransform bgmSlider;
    ...
    public void BackButton()
    {
        ...
        bgmSlider.DOAnchorPos(new Vector2(0, -993), 0.7f).SetEase(Ease.OutCubic).SetUpdate(true);
    ...
    public void MouseButton()
    {
        if (!button)
        {
            ...
            bgmSlider.DOAnchorPos(new Vector2(0, 128), 0.7f).SetEase(Ease.OutCubic).SetUpdate(true);
            sfxSlider.DOAnchorPos(new Vector2(0, -102), 0.7f).SetEase(Ease.OutCubic).SetUpdate(true);
